...
function btnf1() {
	...
	if (value1 < 501 && value2 < 751 && value2 > 649) {
		para1.textContent = v1 + v2 + 75 + ' р';
		para1.style.border = 'none';
		sectioncalc1.appendChild(para1);
	}
	if (value1 < 501 && value2 < 851 && value2 > 749) {
		para1.textContent = v1 + v2 + 225 + ' р';
		para1.style.border = 'none';
		sectioncalc1.appendChild(para1);
	}
	if (value1 < 501 && value2 < 1001 && value2 > 849) {
		para1.textContent = v1 + v2 + 420 + ' р';
		para1.style.border = 'none';
		sectioncalc1.appendChild(para1);
	}
	...
	if (value1 > 849 && value2 < 1001) {
		para1.textContent = (value2 - value1)*3 + ' р';
		para1.style.border = 'none';
		sectioncalc1.appendChild(para1);
	}
	error1();
...
function btnf2() {
	...
	para2.textContent = (value4 - value3)*0.45 + ' р';
